...
Análisis 1: Fuerzas de Dispersión de London

Análisis 2: Fuerzas Intermoleculares por Familia

Análisis 3: Acidez y Estabilidad por Resonancia

Análisis 4: Evaluación de Riesgo Ambiental

Análisis 5: Distribución de la Muestra

Análisis 6: Efecto del Mecanismo en el Producto

Análisis 7: Criticidad de Solventes por Reacción

Análisis 8: Clasificación Ecológica de Solventes

Análisis 9: Cambio de Acidez en la Reacción

Análisis 10: Catalizadores Más Utilizados (Corregido)

Análisis 11C: Perfil de Toxicidad

Tabla de Modificaciones Comunes
...
python
# Opciones para COLOR_PALETTE:
COLOR_PALETTE = 'viridis'      # Verde-azul
COLOR_PALETTE = 'coolwarm'     # Rojo-azul
COLOR_PALETTE = 'Blues'        # Azules
COLOR_PALETTE = 'RdYlGn'       # Rojo-Amarillo-Verde
COLOR_PALETTE = 'Set1'         # Colores vivos
COLOR_PALETTE = 'pastel'       # Colores suaves
COLOR_PALETTE = 'dark'         # Colores oscuros
...
Colores	POINT_COLOR = 'steelblue', BAR_COLOR = 'coral'	'red', 'green', 'purple', '#FF5733'
Paletas	COLOR_PALETTE = 'Set2'	'viridis', 'coolwarm', 'Blues', 'RdYlGn'
Tamaño figura	FIG_SIZE = (12, 8)	(10, 6), (14, 10)
Transparencia	POINT_ALPHA = 0.7	0.3 (más transparente), 1.0 (opaco)
Rangos de datos	PM_MIN, PM_MAX = 40, 300	Cambiar según tus datos
Umbrales toxicidad	UMBRAL_MUY_TOXICO = 1.7	Calcular con np.log10(valor)
Rotación etiquetas	ROTATION = 45	0 (horizontal), 90 (vertical)
Estilo línea	TREND_STYLE = '--'	'-' (sólido), ':' (punteado), '-.' (guión-punto)
Umbrales LD50	UMBRAL_MUY_TOXICO = 50	25, 100 según criterio
Pareto	PARETO_LINE = 80	70, 90
